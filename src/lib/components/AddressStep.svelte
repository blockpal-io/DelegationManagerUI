...
<div class="space-y-4">
  ...
  <p class="text-gray-300">
    Enter the Solana address or .sol name you want to delegate permissions to.
  </p>
  ...
  <div class="space-y-4">
    ...
    <div class="space-y-2">
      ...
      <input
        type="text"
        id="address"
        class="w-full bg-black/10 backdrop-blur-sm border border-white/10 rounded-xl px-4 py-2 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan/50 focus:border-cyan/50 transition-all duration-300 {addressError
          ? 'border-red-500'
          : ''}"
    ...
    {#if additionalDelegates.length > 0}
      <div class="mt-6 space-y-4">
        ...
        {#each additionalDelegates as delegate, i}
          <div
            class="p-4 bg-black/10 backdrop-blur-sm border border-white/10 rounded-xl space-y-2 relative"
          >
            <button
